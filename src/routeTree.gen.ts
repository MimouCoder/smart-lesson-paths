...
const AuthenticatedStudyLessonIdRoute =
  AuthenticatedStudyLessonIdRouteImport.update({
    id: '/study/$lessonId',
    path: '/study/$lessonId',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/study/$lessonId': {
      id: '/_authenticated/study/$lessonId'
      path: '/study/$lessonId'
      fullPath: '/study/$lessonId'
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedStudyLessonIdRoute: typeof AuthenticatedStudyLessonIdRoute
}

const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  AuthenticatedLibraryRoute: AuthenticatedLibraryRoute,
  AuthenticatedStudyLessonIdRoute: AuthenticatedStudyLessonIdRoute,
}
